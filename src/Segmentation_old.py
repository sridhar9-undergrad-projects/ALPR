...
input_folder = r"C:\Users\SRIDHAR\Documents\python\final\plates";
output_folder= r"C:\Users\SRIDHAR\Documents\python\final\seg_old";
   ...
   # cv2.imwrite(os.path.join(output_folder,"first.jpg"),copyThresh);
    ...
    for i in range(1,cols):
        if threshold >= verticalProjection[i] and characterEncounter == 1:
            ...
            #print(tempChar = pytesseract.image_to_string(Image.open(os.path.join(output_folder, str(i) + ".jpg")),config='-psm 10000'))
            tempChar = pytesseract.image_to_string(Image.open(os.path.join(output_folder, str(i) + ".jpg")),config='-psm 10000')
            #print(tempChar)
